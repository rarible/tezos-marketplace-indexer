...
from rarible_marketplace_indexer import models as models
from rarible_marketplace_indexer.types.tezos_domains_registry.big_map.store_records_key import StoreRecordsKey
from rarible_marketplace_indexer.types.tezos_domains_registry.big_map.store_records_value import StoreRecordsValue


async def on_tezos_domains_update_records(
    ctx: HandlerContext,
    store_records: BigMapDiff[StoreRecordsKey, StoreRecordsValue],
) -> None:
    logger = logging.getLogger("dipdup.tezos_domains")
