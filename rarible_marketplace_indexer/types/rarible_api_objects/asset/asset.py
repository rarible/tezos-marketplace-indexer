...
class TokenAsset(AbstractAsset):
    _asset_class: Literal[
        AssetClassEnum.FUNGIBLE_TOKEN,
        AssetClassEnum.NON_FUNGIBLE_TOKEN,
        AssetClassEnum.MULTI_TOKEN,
        AssetClassEnum.COLLECTION,
    ] = None
...
class Asset(AbstractAsset):
    ...
    @classmethod
    def make_from_model(cls, model: Model) -> AbstractAsset:
        asset = parse_obj_as(
            cls,
            {
                'asset_type': {
    ...
    @classmethod
    def take_from_model(cls, model: Model) -> Optional[AbstractAsset]:
